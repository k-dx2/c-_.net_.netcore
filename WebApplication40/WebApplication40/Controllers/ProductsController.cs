...
namespace WebApplication40.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdID,ProdName,ProdCat,ProdPrice")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdID,ProdName,ProdCat,ProdPrice")] Product product)
        {
